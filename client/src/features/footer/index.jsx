...
export default class Footer extends React.Component {
  ...
  render(){
    return(
      <SparkProxy.div className="row center-xs footerContainer" proxyId="footerProxy">
        <SparkScroll.div
          className={cx("footerContent animated", {
            'fadeInDown': this.state.entering,
            'fadeOutDown': this.state.leaving
          })}
          proxy="footerProxy"
          timeline={{
            bottomBottom: {
